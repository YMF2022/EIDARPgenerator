...
ts_lines = [Transitline(:straight, 5, 3.0, 30.0, 60.0, 1.0),
            Transitline(:straight, 5, 3.0, 30.0, 60.0, 1.0),
            Transitline(:circle, 9, 3.0, 30.0, 60.0, 1.0)]
...
generate(3, ts_lines, params, :crossring, replace = 1)

# demand_list = collect(2:2:20)
