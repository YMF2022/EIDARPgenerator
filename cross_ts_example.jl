...
# define train lines
ts_lines = [Transitline(:straight, 3, 2, 3.0, 30.0, 60.0, 1.0),
            Transitline(:straight, 3, 2, 3.0, 30.0, 60.0, 1.0)]
...
generate(3, ts_lines, params, :cross_ts; replace = 1, location = random_spread)